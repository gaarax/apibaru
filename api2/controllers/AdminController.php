...
namespace api2\modules\api\controllers;

use Yii;
use api2\modules\api\models\ApiUser;
use yii\data\ActiveDataProvider;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use api2\compat\HForm;
...
class AdminController extends \api2\modules\admin\components\Controller
{
    ...
    public function behaviors()
    {
        return [
            'acl' => [
                'class' => \api2\components\behaviors\AccessControl::className(),
                'adminOnly' => true
            ]
        ];
    }
